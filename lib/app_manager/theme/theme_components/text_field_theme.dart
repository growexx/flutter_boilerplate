...
class CustomTextFieldTheme {
  static final InputDecorationTheme primaryLight = InputDecorationTheme(
      isDense: true,
      ...
      border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(2),
          borderSide: BorderSide(color: AppColor.hintColor, width: 1)));
  static final InputDecorationTheme primaryDark = InputDecorationTheme(
      isDense: true,
      contentPadding: const EdgeInsets.all(12),
      labelStyle: const TextStyle(
          fontFamily: AppConstant.fontFamily,
      ...
      hintStyle: TextStyle(
          fontFamily: AppConstant.fontFamily,
          color: AppColor.hintColorForDarkTheme,
          fontSize: 14,
          fontWeight: FontWeight.w400),
      errorStyle:  TextStyle(
          fontFamily: AppConstant.fontFamily,
      ...
      enabledBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(2),
          borderSide: BorderSide(color: AppColor.hintColorForDarkTheme, width: 1)),
      border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(2),
          borderSide: BorderSide(color: AppColor.hintColorForDarkTheme, width: 1)));

...
void main() async {
  ...
  group("OTP Widget test", () {
    testWidgets('OTP widget', (WidgetTester tester) async {
      ...
      MockSocialSignInViewModel mockSocialSignInViewModel = MockSocialSignInViewModel();
      MockUserRepository mockUserRepository = MockUserRepository();

      Widget widget = testingWidget(child: OTPWidget(googleSignInViewModel: mockSocialSignInViewModel,
